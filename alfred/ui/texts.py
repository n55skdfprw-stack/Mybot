...
HELP = ("🎩 С удовольствием расскажу, Сэр!\n\nПишите мне обычными словами — я пойму.\n\n"
        "📋 Дела — список того, что нужно сделать: «Завтра купить молоко». Нажмите ⭕ — дело отмечено. "
        "Утром, днём и вечером напомню, что осталось.\n\n"
        "🕰️ Распорядок — встречи и занятия со временем: «В среду в 18:00 тренировка», «Каждый понедельник "
        "в 9 планёрка». Напомню заранее, а вечером пришлю план на завтра.\n\n"
        "📝 Заметки — всё, что нужно не забыть: «Запиши: код от домофона 1234». Потом найду по словам.\n\n"
        "💰 Финансы — записываю, сколько потратили и получили: «Потратил 300 на такси», «Пришла зарплата "
        "50 000». Покажу, сколько ушло за месяц и на что. Помню долги: «Сергей должен мне 5000». "
        "Подскажу курс любой валюты («лира») и пересчитаю: «100 долларов в рублях».\n\n"
        "🎂 Дни рождения — «У мамы др 12 марта». Напомню за неделю, накануне и в сам день и подскажу 🎁 идеи подарка.\n\n"
        "🗂️ Досье — всё о близких и знакомых: «Маша любит пионы», «Номер Сергея +7…». "
        "Найду: «Кто работает тренером?».\n\n"
        "🩺 Медкарта — «Заболел ангиной, назначили амоксициллин 3 раза в день 7 дней». Напомню принять "
        "лекарства, а через год подскажу, чем лечились.\n\n"
        "🌤 Погода — «Какая погода завтра?». Утром пришлю погоду и совет, если нужен зонт. Уехали — «Я в Москве».\n\n"
        "✏️ Ошиблись — исправьте словами: «Не 700, а 800», «Исправь имя на Даня».\n\n"
        "В синей кнопке «Меню»:\n"
        "⏸ Пауза — я замолчу: не буду ничего присылать и отвечать, пока не нажмёте «▶️ Продолжить».\n"
        "🧹 Чистый лист — удалю все ваши записи, чтобы начать с нуля (сначала спрошу подтверждение).")
...
TOO_FAST = "🎩 Сэр, не так быстро! Дайте мне минутку, и продолжим."
TOO_LONG = "🎩 Сэр, сообщение слишком длинное! Разбейте его, пожалуйста, на части до {n} символов."
