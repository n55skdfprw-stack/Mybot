...
- «Отмени тренировку», «тренировки не будет» — DELETE_EVENT. «Что у меня сегодня/завтра/на неделе», «покажи расписание» — SHOW_SCHEDULE (в event_when — «сегодня», «завтра» или «на неделю»).
